...
export interface BusinessSchedule {
  mon: BusinessHours | null; tue: BusinessHours | null; wed: BusinessHours | null
  thu: BusinessHours | null; fri: BusinessHours | null; sat: BusinessHours | null; sun: BusinessHours | null
}
...
export interface Business {
  ...
  logo: string; coverImage: string; images: string[]
  ...
  hasDelivery: boolean; hasOnlinePayment: boolean; acceptsQR: boolean
...
export interface BusinessStats {
  totalViews: number; totalContacts: number; totalFavorites: number
  viewsThisWeek: number; contactsThisWeek: number; topPosts: string[]
}
