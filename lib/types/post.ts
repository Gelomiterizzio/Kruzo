...
export interface Post {
  ...
  businessSlug: string; businessLogo: string; ownerId: string
  title: string; description: string; images: string[]
  price: number; currency: 'BOB'; priceType: PriceType; originalPrice?: number
  category: string; subcategory: string; tags: string[]
  inStock: boolean; stockCount: number | null
  hasDelivery: boolean; deliveryZones: string[]; deliveryPrice: number
  whatsapp: string; whatsappMessage: string
  viewCount: number; likeCount: number; commentCount: number; shareCount: number
  status: PostStatus; isFeatured: boolean
  createdAt: Timestamp; updatedAt: Timestamp
}

export interface PostFormData {
  title: string; description: string; price: number; priceType: PriceType
  originalPrice?: number; category: string; subcategory: string; tags: string
...
export interface PostComment {
  ...
  userName: string; userPhoto: string; text: string; createdAt: Timestamp
}
